...
for i in'formulahendry.code-runner','dpar39.vscode-rest-control':"'.."in(extension:=run('code --install-extension '+i,shell=1,capture_output=1,text=1).stdout)and print(extension)
