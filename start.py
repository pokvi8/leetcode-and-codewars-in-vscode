...
for i in'venv','update','run':script[f'src/{i}.py']=(folder/f'src/{i}.py').exists()if i!='venv'else pip.exists()and python.exists()and'playwright'in run((pip,'freeze'),capture_output=1).stdout.decode()
